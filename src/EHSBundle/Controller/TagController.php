...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('EHSBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('EHSBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('EHSBundle\Form\TagType', $tag);
